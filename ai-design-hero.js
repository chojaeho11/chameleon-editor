import { sb } from './config.js?v=441';
...
const AI_I18N = {
    ...
    ja: {
        ...
        uploadBtn:'画像添付 (最大4枚)', genBtn:'🎨 AIデザイン生成', genBtnLoading:'⏳ 生成中...', previewHint:'プレビュー · 間もなく鮮明になります', emptyMain:'例 — 「カメレオン × ケデホン コラボ」のテキストだけで素敵なポスターが完成します。',
        emptySub:'ダウンロード後、ファブリックや紙に印刷してみてください。<br>世界に一つだけの作品が作れます。<b>高画質エンジンで約3分かかります。</b>',
        loadMain:'AIがデザイン生成中です', loadSub:'高画質エンジンで約3分かかります。しばらくお待ちください。',
    ...
    en: {
        ...
        uploadBtn:'Attach images (up to 4)', genBtn:'🎨 Generate AI Design', genBtnLoading:'⏳ Generating...', previewHint:'Preview · sharpening soon', emptyMain:'Example — a stunning poster from just the text "Chameleon × KDH Collab".',
        emptySub:'Download and print on fabric or paper.<br>Create a one-of-a-kind work of art. <b>The high-quality engine takes ~3 minutes.</b>',
        loadMain:'AI is generating your design', loadSub:'The high-quality engine takes ~3 minutes. Please wait.',
    ...
    zh: {
        ...
        uploadBtn:'附加图片 (最多4张)', genBtn:'🎨 生成AI设计', genBtnLoading:'⏳ 生成中...', previewHint:'预览 · 即将清晰', emptyMain:'示例 — 仅凭"变色龙 × KDH 联名"几个字，即可生成精彩海报。',
        emptySub:'下载后印在面料或纸上。<br>打造世上独一无二的作品。<b>高画质引擎约需 3 分钟。</b>',
        loadMain:'AI正在生成设计', loadSub:'高画质引擎约需 3 分钟，请稍候。',
    ...
    ar: {
        ...
        uploadBtn:'إرفاق صور (حتى 4)', genBtn:'🎨 إنشاء تصميم بالذكاء الاصطناعي', genBtnLoading:'⏳ جارٍ الإنشاء...', previewHint:'معاينة · ستصبح أكثر وضوحًا قريبًا', emptyMain:'مثال — ملصق رائع يُنشأ من نص "Chameleon × KDH Collab" فقط.',
        emptySub:'قم بتنزيله واطبعه على القماش أو الورق.<br>اصنع تحفة فنية فريدة من نوعها. <b>يستغرق محرك الجودة العالية حوالي 3 دقائق.</b>',
        loadMain:'يقوم الذكاء الاصطناعي بإنشاء التصميم', loadSub:'يستغرق محرك الجودة العالية حوالي 3 دقائق. يرجى الانتظار.',
    ...
    es: {
        ...
        uploadBtn:'Adjuntar imágenes (hasta 4)', genBtn:'🎨 Generar Diseño IA', genBtnLoading:'⏳ Generando...', previewHint:'Vista previa · pronto se aclarará', emptyMain:'Ejemplo — un póster impresionante creado solo con el texto "Chameleon × KDH Collab".',
        emptySub:'Descárgalo e imprímelo en tela o papel.<br>Crea una obra de arte única en el mundo. <b>El motor de alta calidad tarda unos 3 minutos.</b>',
        loadMain:'La IA está generando tu diseño', loadSub:'El motor de alta calidad tarda unos 3 minutos. Por favor espere.',
    ...
    de: {
        ...
        uploadBtn:'Bilder anhängen (bis 4)', genBtn:'🎨 KI-Design generieren', genBtnLoading:'⏳ Wird generiert...', previewHint:'Vorschau · wird gleich schärfer', emptyMain:'Beispiel — ein beeindruckendes Poster nur aus dem Text „Chameleon × KDH Collab".',
        emptySub:'Laden Sie es herunter und drucken Sie es auf Stoff oder Papier.<br>Erschaffen Sie ein einzigartiges Kunstwerk. <b>Die hochauflösende Engine dauert ca. 3 Minuten.</b>',
        loadMain:'KI erstellt Ihr Design', loadSub:'Die hochauflösende Engine dauert ca. 3 Minuten. Bitte warten.',
    ...
    fr: {
        ...
        uploadBtn:'Joindre des images (max 4)', genBtn:'🎨 Générer le Design IA', genBtnLoading:'⏳ Génération...', previewHint:'Aperçu · bientôt plus net', emptyMain:'Exemple — une affiche superbe à partir du seul texte « Chameleon × KDH Collab ».',
        emptySub:'Téléchargez-la et imprimez-la sur du tissu ou du papier.<br>Créez une œuvre d\'art unique au monde. <b>Le moteur haute qualité prend environ 3 minutes.</b>',
        loadMain:'L\'IA génère votre design', loadSub:'Le moteur haute qualité prend environ 3 minutes. Veuillez patienter.',
