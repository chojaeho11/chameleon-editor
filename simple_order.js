      ...
      <div class="so-right">
        ...
        <div class="so-section" id="soScheduleSection" style="display:none;">
          ...
          <div id="soShipBtnGrid" style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:12px;">
            ...
            <button type="button" class="so-ship-btn so-ship-free-metro" data-ship="metro_install" onclick="window._soPickShip('metro_install')" style="grid-column:1/-1; background:linear-gradient(135deg,#03c75a,#00b04f); color:#fff; border-color:#00b04f; font-weight:900; font-size:14px; padding:14px; box-shadow:0 6px 18px -6px rgba(3,199,90,0.55); letter-spacing:0.2px;">${tr('수도권 무료배송 · 무료설치', '首都圏 送料・設置 無料', 'Metro · FREE delivery & install')}</button>
