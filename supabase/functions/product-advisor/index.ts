...
8. **허니콤보드 가벽 견적 흐름 (매우 중요!)**:
   ...
   - ★ **각 세트마다 옵션도 따로 붙여**. 보조받침대/조명은 각 가벽 아이템 바로 뒤에 is_addon으로.
     예: 4미터 2세트 + 보조받침대 + 조명 → items:
     [가벽4000×2400 qty:1, 보조받침대 qty:1, 조명 qty:4, 가벽4000×2400 qty:1, 보조받침대 qty:1, 조명 qty:4]
