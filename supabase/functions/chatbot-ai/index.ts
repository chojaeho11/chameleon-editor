    ...
    try {
        ...
        const langPrompts: Record<string, { intro: string; rules: string; shipping: string; discount: string; payment: string; manager: string; services: string; orderTracking: string }> = {
            kr: {
                ...
                shipping: `- ⭐ 허니콤보드(리보드) 외 전 제품 무료배송!\n- 허니콤보드(리보드) 배송·설치·철거 정책 (★최신★):\n  · 수도권(서울/경기) 100만원 이상: 무료 배송 + 무료 설치 (※ 철거는 항상 별도 유료 10만원!)\n  · 수도권(서울/경기) 100만원 미만: 유료 배송 10만원 (설치 포함) + 철거 별도 10만원\n  · 지방 설치배송: 70만원 (배송+설치, 철거 별도)\n  · 지방 용차배송: 20만원 (설치 불가, 배송만)\n  · 보드류 택배: 30,000원\n  · 일반택배: 5,000원\n  · 수도권 철거 단독: 10만원 (반드시 유료)\n- ⚠️ 철거는 어떤 경우에도 항상 별도 유료 10만원 — "100만원 이상도 철거 무료"라고 절대 말하지 말 것!\n- 제작기간: 2~3영업일, 급행: 매니저 문의\n- 배송기간: 수도권 1~2일, 지방 2~3일\n- 🚢 ⭐ FOB 해외배송 (허니콤보드 / 허니콤보드 원판 / 종이매대 / 허니콤보드 매대):\n  · 위 4개 카테고리 해외 주문은 **FOB(Free On Board) 방식**으로 선적해 드립니다.\n  · **한국 또는 모로코 공장**에서 발송 가능 — 고객 위치에 가까운 쪽에서 출고합니다.\n  · FOB 조건이므로 본선 적재까지는 당사 부담, 이후 해상운임·관세·현지 통관은 고객 부담입니다.\n  · 자세한 FOB 견적은 매니저(031-366-1984) 또는 상담사 연결로 문의해 주세요.\n- 해외 출장 설치 비용: 항공+숙박비 실비 + 시공 당일 1인 300불\n- 설치 문의: 031-366-1984 또는 상담사 연결`,
                discount: `- 사업자 회원은 파트너스가 되실 수 있으며 10%할인이 적용됩니다.\n- Franchise: 10%, Platinum/Partner: 5%, Gold: 3%`,
                payment: `- 카드(토스페이먼츠), 무통장입금, 예치금, 마일리지(최대 5%)`,
                manager: `- ⭐ 답변이 곤란하거나 견적/대량주문/맞춤상담 시 → 아래 연락처 적극 안내!\n- 본사 대표: 031-366-1984 (평일 09~18시)\n- 매니저: 지숙 010-3455-1946 / 은미 010-7793-5393 / 성희 010-3490-3328 (전화·문자·카톡 모두 가능)\n- 이메일: design@chameleon.design (대량/견적/대용량 파일)\n- VIP 대량주문 문의: 위 매니저 직접 연락 또는 하단 '상담사 연결' 버튼\n- 일본 지사: 洪志汶(ホンジウン) 070-3202-9352 / design@chameleon.design / 047-712-1148\n- 일본 명함: https://www.cafe0101.com/japan_card.png`,
            ...
            ja: {
                ...
                shipping: `- ⭐ ハニカムボード以外の全商品：送料完全無料！\n- 🚢 ⭐ FOB海上輸送（ハニカムボード／ハニカムボード原板／紙什器／ハニカムボード什器）:\n  · 上記4カテゴリの海外ご注文は **FOB（Free On Board）条件** で出荷いたします。\n  · **韓国または モロッコ工場** から発送可能 — お客様の地域に近い方から出荷します。\n  · FOB条件のため本船積込までは当社負担、以降の海上運賃・関税・現地通関はお客様ご負担となります。\n  · 東京近郊（関東エリア）は従来通り送料無料＋設置無料対応も可能です。\n  · 正確なFOB見積もりはマネージャーへお問い合わせください。\n- 製作期間: 2〜3営業日\n- 配送期間: 東京近郊 5〜7営業日、その他 7〜14営業日\n- 配送方法は2つ：①梱包して配送のみ ②韓国本社チームが現地に出張して直接設置\n- 出張設置費用：航空券＋宿泊費（実費）＋施工当日1人$300\n- チャットやZoomで設置方法を丁寧にご説明することも可能です！`,
            ...
            us: {
                ...
                shipping: `- ⭐ Free shipping on ALL products EXCEPT Honeycomb Board category!\n- 🚢 ⭐ FOB Shipping (Honeycomb Board / Honeycomb Raw Sheets / Paper Displays / Honeycomb Displays):\n  · These 4 categories ship on **FOB (Free On Board) terms** for international orders.\n  · Shipped from either our **Korea or Morocco factory** — whichever is closer to you.\n  · Under FOB terms, we cover costs up to loading on board; ocean freight, duties, and local customs are on the buyer's side.\n  · US East Coast reference: approx $3,000~$4,000 / US West Coast: approx $2,500~$3,500 (freight estimates)\n  · For exact FOB quotes, please contact a manager.\n- All other products: completely FREE shipping worldwide!\n- Production: 2-3 business days\n- Delivery: 2-4 weeks (international shipping from Korea or Morocco)\n- Two delivery options: ① Packaged FOB shipping only ② Our HQ team flies out for on-site installation\n- On-site installation cost: airfare + hotel (actual cost) + $300/person per installation day\n- We also offer remote installation guidance via chat or Zoom!\n- International consultation: +82-10-3491-3535 (English/Japanese)`,
