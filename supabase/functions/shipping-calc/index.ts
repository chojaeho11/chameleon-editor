...
const CITY_COORDS: Record<string, { lat: number; lng: number }> = {
    ...
    "세종": { lat: 36.48, lng: 127.26 }, "sejong": { lat: 36.48, lng: 127.26 },
    // Korea - 제주
    "제주": { lat: 33.50, lng: 126.53 }, "jeju": { lat: 33.50, lng: 126.53 }, "서귀포": { lat: 33.25, lng: 126.56 },
    // Korea - 경기도
    ...
    "성남": { lat: 37.42, lng: 127.13 }, "seongnam": { lat: 37.42, lng: 127.13 },
    "고양": { lat: 37.66, lng: 126.83 }, "goyang": { lat: 37.66, lng: 126.83 },
    "용인": { lat: 37.24, lng: 127.18 }, "yongin": { lat: 37.24, lng: 127.18 },
    "안양": { lat: 37.39, lng: 126.95 }, "anyang": { lat: 37.39, lng: 126.95 },
    "안산": { lat: 37.32, lng: 126.83 }, "ansan": { lat: 37.32, lng: 126.83 },
    "평택": { lat: 36.99, lng: 127.09 }, "pyeongtaek": { lat: 36.99, lng: 127.09 },
    "시흥": { lat: 37.38, lng: 126.80 }, "siheung": { lat: 37.38, lng: 126.80 },
    "파주": { lat: 37.76, lng: 126.78 }, "paju": { lat: 37.76, lng: 126.78 },
    "김포": { lat: 37.61, lng: 126.72 }, "gimpo": { lat: 37.61, lng: 126.72 },
    "광명": { lat: 37.48, lng: 126.87 }, "gwangmyeong": { lat: 37.48, lng: 126.87 },
    "이천": { lat: 37.27, lng: 127.44 }, "icheon": { lat: 37.27, lng: 127.44 },
    "양주": { lat: 37.79, lng: 127.05 },
    "오산": { lat: 37.15, lng: 127.07 },
    "구리": { lat: 37.60, lng: 127.13 },
    "남양주": { lat: 37.64, lng: 127.22 },
    "하남": { lat: 37.54, lng: 127.21 },
    "의정부": { lat: 37.74, lng: 127.05 },
    "동두천": { lat: 37.90, lng: 127.06 },
    "포천": { lat: 37.89, lng: 127.20 },
    "여주": { lat: 37.30, lng: 127.64 },
    "양평": { lat: 37.49, lng: 127.49 },
    "가평": { lat: 37.83, lng: 127.51 },
    // Korea - 충청도
    "천안": { lat: 36.81, lng: 127.11 }, "cheonan": { lat: 36.81, lng: 127.11 },
    "청주": { lat: 36.64, lng: 127.49 }, "cheongju": { lat: 36.64, lng: 127.49 },
    "충주": { lat: 36.97, lng: 127.95 }, "chungju": { lat: 36.97, lng: 127.95 },
    "아산": { lat: 36.79, lng: 127.00 }, "asan": { lat: 36.79, lng: 127.00 },
    "서산": { lat: 36.78, lng: 126.45 },
    "당진": { lat: 36.89, lng: 126.63 },
    "논산": { lat: 36.19, lng: 127.10 },
    "제천": { lat: 37.13, lng: 128.19 },
    "보령": { lat: 36.33, lng: 126.61 },
    "공주": { lat: 36.45, lng: 127.12 },
    // Korea - 전라도
    "전주": { lat: 35.82, lng: 127.15 }, "jeonju": { lat: 35.82, lng: 127.15 },
    "목포": { lat: 34.81, lng: 126.39 }, "mokpo": { lat: 34.81, lng: 126.39 },
    "여수": { lat: 34.74, lng: 127.66 }, "yeosu": { lat: 34.74, lng: 127.66 },
    "순천": { lat: 34.95, lng: 127.49 }, "suncheon": { lat: 34.95, lng: 127.49 },
    "군산": { lat: 35.97, lng: 126.74 }, "gunsan": { lat: 35.97, lng: 126.74 },
    "익산": { lat: 35.95, lng: 126.96 },
    "남원": { lat: 35.42, lng: 127.39 },
    "정읍": { lat: 35.57, lng: 126.86 },
    "광양": { lat: 34.94, lng: 127.70 },
    "나주": { lat: 35.02, lng: 126.71 },
    // Korea - 경상도
    "포항": { lat: 36.02, lng: 129.37 }, "pohang": { lat: 36.02, lng: 129.37 },
    "구미": { lat: 36.12, lng: 128.34 }, "gumi": { lat: 36.12, lng: 128.34 },
    "경주": { lat: 35.86, lng: 129.22 }, "gyeongju": { lat: 35.86, lng: 129.22 },
    "김해": { lat: 35.23, lng: 128.89 }, "gimhae": { lat: 35.23, lng: 128.89 },
    "창원": { lat: 35.23, lng: 128.68 }, "changwon": { lat: 35.23, lng: 128.68 },
    "마산": { lat: 35.18, lng: 128.57 }, "masan": { lat: 35.18, lng: 128.57 },
    "진주": { lat: 35.18, lng: 128.11 }, "jinju": { lat: 35.18, lng: 128.11 },
    "거제": { lat: 34.88, lng: 128.62 }, "geoje": { lat: 34.88, lng: 128.62 },
    "통영": { lat: 34.85, lng: 128.43 }, "tongyeong": { lat: 34.85, lng: 128.43 },
    "양산": { lat: 35.34, lng: 129.04 },
    "밀양": { lat: 35.50, lng: 128.75 },
    "안동": { lat: 36.57, lng: 128.73 }, "andong": { lat: 36.57, lng: 128.73 },
    "김천": { lat: 36.12, lng: 128.11 },
    "영주": { lat: 36.81, lng: 128.62 },
    "상주": { lat: 36.41, lng: 128.16 },
    "문경": { lat: 36.59, lng: 128.20 },
    "사천": { lat: 35.00, lng: 128.06 },
    // Korea - 강원도
    "춘천": { lat: 37.88, lng: 127.73 }, "chuncheon": { lat: 37.88, lng: 127.73 },
    "원주": { lat: 37.34, lng: 127.95 }, "wonju": { lat: 37.34, lng: 127.95 },
    "강릉": { lat: 37.75, lng: 128.88 }, "gangneung": { lat: 37.75, lng: 128.88 },
    "속초": { lat: 38.21, lng: 128.59 }, "sokcho": { lat: 38.21, lng: 128.59 },
    "동해": { lat: 37.52, lng: 129.11 },
    "태백": { lat: 37.16, lng: 128.99 },
    "삼척": { lat: 37.45, lng: 129.17 },
    "홍천": { lat: 37.69, lng: 127.89 },
    "횡성": { lat: 37.49, lng: 127.98 },
    "영월": { lat: 37.18, lng: 128.46 },
    "정선": { lat: 37.38, lng: 128.66 },
    // Japan - 主要都市
    "東京": { lat: 35.6938, lng: 139.7034 }, "tokyo": { lat: 35.6938, lng: 139.7034 }, "新宿": { lat: 35.6938, lng: 139.7034 }, "shinjuku": { lat: 35.6938, lng: 139.7034 },
    "渋谷": { lat: 35.66, lng: 139.70 }, "shibuya": { lat: 35.66, lng: 139.70 },
    "池袋": { lat: 35.73, lng: 139.71 }, "ikebukuro": { lat: 35.73, lng: 139.71 },
    "品川": { lat: 35.63, lng: 139.74 }, "shinagawa": { lat: 35.63, lng: 139.74 },
    ...
    "千葉": { lat: 35.61, lng: 140.12 }, "chiba": { lat: 35.61, lng: 140.12 },
    "さいたま": { lat: 35.86, lng: 139.65 }, "saitama": { lat: 35.86, lng: 139.65 },
    "川崎": { lat: 35.53, lng: 139.70 }, "kawasaki": { lat: 35.53, lng: 139.70 },
    "北九州": { lat: 33.88, lng: 130.88 }, "kitakyushu": { lat: 33.88, lng: 130.88 },
    "熊本": { lat: 32.79, lng: 130.69 }, "kumamoto": { lat: 32.79, lng: 130.69 },
    "岡山": { lat: 34.66, lng: 133.93 }, "okayama": { lat: 34.66, lng: 133.93 },
    "静岡": { lat: 34.98, lng: 138.38 }, "shizuoka": { lat: 34.98, lng: 138.38 },
    "新潟": { lat: 37.90, lng: 139.02 }, "niigata": { lat: 37.90, lng: 139.02 },
    "浜松": { lat: 34.71, lng: 137.73 }, "hamamatsu": { lat: 34.71, lng: 137.73 },
    "長崎": { lat: 32.75, lng: 129.88 }, "nagasaki": { lat: 32.75, lng: 129.88 },
    "鹿児島": { lat: 31.60, lng: 130.56 }, "kagoshima": { lat: 31.60, lng: 130.56 },
    "那覇": { lat: 26.34, lng: 127.68 }, "naha": { lat: 26.34, lng: 127.68 }, "okinawa": { lat: 26.34, lng: 127.68 },
    "金沢": { lat: 36.56, lng: 136.65 }, "kanazawa": { lat: 36.56, lng: 136.65 },
    "松山": { lat: 33.84, lng: 132.77 }, "matsuyama": { lat: 33.84, lng: 132.77 },
    "高松": { lat: 34.34, lng: 134.05 }, "takamatsu": { lat: 34.34, lng: 134.05 },
    "徳島": { lat: 34.07, lng: 134.56 }, "tokushima": { lat: 34.07, lng: 134.56 },
    "盛岡": { lat: 39.70, lng: 141.15 }, "morioka": { lat: 39.70, lng: 141.15 },
    "秋田": { lat: 39.72, lng: 140.10 }, "akita": { lat: 39.72, lng: 140.10 },
    "青森": { lat: 40.82, lng: 140.75 }, "aomori": { lat: 40.82, lng: 140.75 },
    // US
...
serve(async (req) => {
    ...
    try {
        ...
        const honeycombNA = { kr: "허니콤보드는 택배 불가", ja: "ハニカムボードは宅配不可", en: "Honeycomb Board: courier unavailable", zh: "蜂窝板无法快递" };
