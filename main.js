...
import { initConfig, sb, currentUser, PRODUCT_DB } from "./config.js?v=288";
import { initCanvas, canvas } from "./canvas-core.js?v=288";
import { initSizeControls, applySize } from "./canvas-size.js?v=288";
import { initGuides } from "./canvas-guides.js?v=288";
import { initZoomPan } from "./canvas-zoom-pan.js?v=288";
import { initObjectTools } from "./canvas-objects.js?v=288";
import { initPageTools } from "./canvas-pages.js?v=288"; // [추가] 페이지 도구
import { initImageTools } from "./canvas-image.js?v=288";
import { initTemplateTools, loadProductFixedTemplate } from "./canvas-template.js?v=288";
import { initAiTools } from "./canvas-ai.js?v=288";
import { initExport } from "./export.js?v=288";
import { initOrderSystem } from "./order.js?v=288";
import { initAuth } from "./login.js?v=288";
import { initMyDesign } from "./my-design.js?v=288";
import { initCanvasUtils } from "./canvas-utils.js?v=288";
import { initShortcuts } from "./shortcuts.js?v=288";
import { initContextMenu } from "./context-menu.js?v=288";
import { createVectorOutline } from "./outlineMaker.js?v=288";
import { initVideoMaker } from "./video-maker.js?v=288";
import { initPptMode } from "./ppt-mode.js?v=288";
import { initGreetingCardMode } from "./greeting-card-mode.js?v=288";
import { initIconTools } from "./canvas-icons.js?v=288";
import { initRetouchTools } from "./canvas-retouch.js?v=288";
