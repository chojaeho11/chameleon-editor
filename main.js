...
import { initConfig, sb, currentUser, PRODUCT_DB } from "./config.js?v=175";
import { initCanvas, canvas } from "./canvas-core.js?v=175";
import { initSizeControls, applySize } from "./canvas-size.js?v=175";
import { initGuides } from "./canvas-guides.js?v=175";
import { initZoomPan } from "./canvas-zoom-pan.js?v=175";
import { initObjectTools } from "./canvas-objects.js?v=175";
import { initPageTools } from "./canvas-pages.js?v=175"; // [추가] 페이지 도구
import { initImageTools } from "./canvas-image.js?v=175";
import { initTemplateTools, loadProductFixedTemplate } from "./canvas-template.js?v=175";
import { initAiTools } from "./canvas-ai.js?v=175";
import { initExport } from "./export.js?v=175";
import { initOrderSystem } from "./order.js?v=175";
import { initAuth } from "./login.js?v=175";
import { initMyDesign } from "./my-design.js?v=175";
import { initCanvasUtils } from "./canvas-utils.js?v=175";
import { initShortcuts } from "./shortcuts.js?v=175";
import { initContextMenu } from "./context-menu.js?v=175";
import { createVectorOutline } from "./outlineMaker.js?v=175";
import { initVideoMaker } from "./video-maker.js?v=175";
import { initPptMode } from "./ppt-mode.js?v=175";
import { initGreetingCardMode } from "./greeting-card-mode.js?v=175";
import { initIconTools } from "./canvas-icons.js?v=175";
import { initRetouchTools } from "./canvas-retouch.js?v=175";
