...
import { initConfig, sb, currentUser, PRODUCT_DB } from "./config.js?v=287";
import { initCanvas, canvas } from "./canvas-core.js?v=287";
import { initSizeControls, applySize } from "./canvas-size.js?v=287";
import { initGuides } from "./canvas-guides.js?v=287";
import { initZoomPan } from "./canvas-zoom-pan.js?v=287";
import { initObjectTools } from "./canvas-objects.js?v=287";
import { initPageTools } from "./canvas-pages.js?v=287"; // [추가] 페이지 도구
import { initImageTools } from "./canvas-image.js?v=287";
import { initTemplateTools, loadProductFixedTemplate } from "./canvas-template.js?v=287";
import { initAiTools } from "./canvas-ai.js?v=287";
import { initExport } from "./export.js?v=287";
import { initOrderSystem } from "./order.js?v=287";
import { initAuth } from "./login.js?v=287";
import { initMyDesign } from "./my-design.js?v=287";
import { initCanvasUtils } from "./canvas-utils.js?v=287";
import { initShortcuts } from "./shortcuts.js?v=287";
import { initContextMenu } from "./context-menu.js?v=287";
import { createVectorOutline } from "./outlineMaker.js?v=287";
import { initVideoMaker } from "./video-maker.js?v=287";
import { initPptMode } from "./ppt-mode.js?v=287";
import { initGreetingCardMode } from "./greeting-card-mode.js?v=287";
import { initIconTools } from "./canvas-icons.js?v=287";
import { initRetouchTools } from "./canvas-retouch.js?v=287";
