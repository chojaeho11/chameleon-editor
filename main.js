...
import { initConfig, sb, currentUser, PRODUCT_DB } from "./config.js?v=130";
import { initCanvas, canvas } from "./canvas-core.js?v=130";
import { initSizeControls, applySize } from "./canvas-size.js?v=130";
import { initGuides } from "./canvas-guides.js?v=130";
import { initZoomPan } from "./canvas-zoom-pan.js?v=130";
import { initObjectTools } from "./canvas-objects.js?v=130";
import { initPageTools } from "./canvas-pages.js?v=130"; // [추가] 페이지 도구
import { initImageTools } from "./canvas-image.js?v=130";
import { initTemplateTools, loadProductFixedTemplate } from "./canvas-template.js?v=130";
import { initAiTools } from "./canvas-ai.js?v=130";
import { initExport } from "./export.js?v=130";
import { initOrderSystem } from "./order.js?v=130";
import { initAuth } from "./login.js?v=130";
import { initMyDesign } from "./my-design.js?v=130";
import { initCanvasUtils } from "./canvas-utils.js?v=130";
import { initShortcuts } from "./shortcuts.js?v=130";
import { initContextMenu } from "./context-menu.js?v=130";
import { createVectorOutline } from "./outlineMaker.js?v=130";
import { initVideoMaker } from "./video-maker.js?v=130";
import { initPptMode } from "./ppt-mode.js?v=130";
import { initGreetingCardMode } from "./greeting-card-mode.js?v=130";
import { initIconTools } from "./canvas-icons.js?v=130";
import { initRetouchTools } from "./canvas-retouch.js?v=130";
