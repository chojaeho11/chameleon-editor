...
const WELCOME = {
    ...
    zh: `想做什么作品请告诉我们 🎨\n有参考图片的话也可以上传哦。\n比如说"朋友结婚，想用500元左右准备一份惊喜"也可以。\n我们会推荐适合您预算的精美商品 😊`,
    es: `Cuéntanos qué te gustaría crear 🎨\nSube una foto de referencia si tienes una.\nPuedes decir "Quiero preparar una sorpresa para la boda de mi amigo con un presupuesto de $100".\nTe ayudaremos a encontrar algo increíble 😊`,
    de: `Sagen Sie uns, was Sie erstellen möchten 🎨\nLaden Sie gerne ein Referenzfoto hoch.\nSie können sagen "Ich möchte eine Überraschung für die Hochzeit meines Freundes mit einem Budget von 100€ vorbereiten".\nWir helfen Ihnen, etwas Tolles zu finden 😊`,
    fr: `Dites-nous ce que vous aimeriez créer 🎨\nN'hésitez pas à télécharger une photo de référence.\nVous pouvez dire "Je veux préparer une surprise pour le mariage de mon ami avec un budget de 100€".\nNous vous aiderons à trouver quelque chose d'incroyable 😊`,
    ar: `أخبرنا ماذا تريد أن تصنع 🎨\nيمكنك تحميل صورة مرجعية إذا كانت لديك.\nيمكنك حتى أن تقول "أريد تحضير مفاجأة لحفل زفاف صديقي بميزانية $100".\nسنساعدك في إيجاد شيء رائع 😊`,
};
