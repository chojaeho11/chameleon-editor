...
async function sendMessage(text, imageData) {
    ...
    try {
        const sysHint = {
            role: 'system',
            content: `[제품 추천 가이드]
★★★ [소량인쇄 강력추천] 청첩장, 포스터, 전단지, 엽서, 리플릿, 초대장 등 소량 인쇄물을 문의하면 반드시 "1장부터 주문가능 소량인쇄" 상품(코드: pp_lf_2)을 최우선 추천하라! "강력추천! 1장부터 인쇄 가능하고, 국내 어떤 인쇄업체보다 저렴합니다. A4 전단지 500원, 엽서 600원부터!"라고 적극 안내. 청첩장도 이 상품으로 소량 제작 가능. 링크: /?product=pp_lf_2
