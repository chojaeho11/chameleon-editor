...
const T = {
    kr: { title: '카프', subtitle: '쇼핑을 안내해 드립니다', studio: '여기서 놀자!', placeholder: '메시지를 입력하세요...', send: '전송', close: '닫기', editor: '에디터에서 디자인', cart: '장바구니', upload: '이미지 첨부', tooBig: '파일이 너무 큽니다 (최대 10MB). 더 큰 파일은 주문 시 업로드하거나 design@chameleon.design으로 보내주세요.', error: '죄송합니다, 답변을 가져오지 못했어요. 본사 031-366-1984로 전화 주시면 빠르게 안내드립니다 😊', reset: '대화 초기화', consultant: '전화 안내', namePh: '이름', callbackTitle: '연락처를 남겨주세요', callbackDesc: '담당자가 확인 후 연락드리겠습니다', callbackSuccess: '연락처가 전달되었습니다! 담당자가 빠른 시간 내에 연락드릴게요', callbackPhonePh: '연락처 입력', callbackSubmit: '연락 요청하기', callbackPhoneErr: '연락처를 입력해주세요', quoteTitle: '전시/부스 견적 요청', quoteDesc: '아래 정보를 입력해주시면 담당자가 맞춤 견적을 보내드립니다', quoteEmailPh: 'email@example.com', quoteDetailPh: '필요한 구조물, 사이즈, 수량 등을 알려주세요', quoteFilePh: '레퍼런스 이미지나 도면을 올려주세요', quoteSubmit: '견적 요청 보내기', quoteSuccess: '견적 요청이 전송되었습니다! 담당자가 빠른 시간 내에 연락드리겠습니다' },
    ja: { title: 'カプ', subtitle: 'ショッピングをご案内します', studio: 'ここで遊ぼう!', placeholder: 'メッセージを入力...', send: '送信', close: '閉じる', editor: 'エディターでデザイン', cart: 'カートに入れる', upload: '画像添付', tooBig: 'ファイルが大きすぎます（最大10MB）。より大きいファイルはdesign@chameleon.designへお送りください。', error: '申し訳ありません、回答を取得できませんでした。お電話 047-712-1148 までお問い合わせください 😊', reset: 'チャットリセット', consultant: 'お電話案内', namePh: 'お名前', callbackTitle: '連絡先をお残しください', callbackDesc: '担当者が確認後、ご連絡いたします', callbackSuccess: '連絡先が送信されました！担当者がすぐにご連絡いたします', callbackPhonePh: '連絡先を入力', callbackSubmit: 'コールバックを依頼', callbackPhoneErr: '連絡先を入力してください', quoteTitle: '展示/ブース見積もり依頼', quoteDesc: '以下の情報をご入力いただければ、担当者がお見積もりをお送りします', quoteEmailPh: 'email@example.com', quoteDetailPh: '必要な構造物、サイズ、数量などをお知らせください', quoteFilePh: '参考画像や図面をアップロードしてください', quoteSubmit: '見積もり依頼を送信', quoteSuccess: '見積もり依頼が送信されました！担当者が早急にご連絡いたします' },
    en: { title: 'Kapu', subtitle: 'Your shopping guide', studio: 'Play Here!', placeholder: 'Type a message...', send: 'Send', close: 'Close', editor: 'Design in Editor', cart: 'Add to Cart', upload: 'Attach image', tooBig: 'File too large (max 10MB). For larger files, please email design@chameleon.design.', error: 'Sorry, I could not retrieve a response. Please call HQ at +82-31-366-1984 for quick assistance 😊', reset: 'Reset chat', consultant: 'Phone numbers', namePh: 'Name', callbackTitle: 'Please leave your number', callbackDesc: 'Our team will review and contact you', callbackSuccess: 'Your contact info has been submitted! Our team will reach out to you shortly', callbackPhonePh: 'Enter phone number', callbackSubmit: 'Request callback', callbackPhoneErr: 'Please enter your phone number', quoteTitle: 'Exhibition/Booth Quote Request', quoteDesc: 'Fill in the details below and our team will send you a custom quote', quoteEmailPh: 'email@example.com', quoteDetailPh: 'Describe the structures, sizes, quantities you need', quoteFilePh: 'Upload reference images or blueprints', quoteSubmit: 'Submit Quote Request', quoteSuccess: 'Your quote request has been submitted! Our team will contact you shortly' },
    zh: { title: '卡普', subtitle: '为您导购', studio: '在这里玩!', placeholder: '请输入消息...', send: '发送', close: '关闭', editor: '在编辑器中设计', cart: '加入购物车', upload: '上传图片', tooBig: '文件太大（最大10MB）。', error: '抱歉，未能获取回复。请致电总部 +82-31-366-1984 获取快速协助 😊', reset: '重置对话', consultant: '电话咨询', namePh: '姓名', callbackTitle: '请留下您的联系方式', callbackDesc: '我们的团队会确认后联系您', callbackSuccess: '联系方式已提交！我们的团队会尽快与您联系', callbackPhonePh: '输入电话号码', callbackSubmit: '请求回拨', callbackPhoneErr: '请输入电话号码' },
    es: { title: 'Kapu', subtitle: 'Tu guía de compras', studio: '¡Juega Aquí!', placeholder: 'Escribe un mensaje...', send: 'Enviar', close: 'Cerrar', editor: 'Diseñar en Editor', cart: 'Añadir al carrito', upload: 'Adjuntar imagen', tooBig: 'Archivo demasiado grande (máx. 10MB).', error: 'Lo siento, no pude obtener una respuesta. Por favor, llame al +82-31-366-1984 😊', reset: 'Reiniciar chat', consultant: 'Teléfono', namePh: 'Nombre', callbackTitle: 'Deja tu número', callbackDesc: 'Nuestro equipo revisará y te contactará', callbackSuccess: '¡Tu información de contacto ha sido enviada! Nuestro equipo se pondrá en contacto contigo pronto', callbackPhonePh: 'Ingresa tu teléfono', callbackSubmit: 'Solicitar llamada', callbackPhoneErr: 'Ingresa tu teléfono' },
    de: { title: 'Kapu', subtitle: 'Ihr Einkaufsberater', studio: 'Hier spielen!', placeholder: 'Nachricht eingeben...', send: 'Senden', close: 'Schließen', editor: 'Im Editor gestalten', cart: 'In den Warenkorb', upload: 'Bild anhängen', tooBig: 'Datei zu groß (max. 10MB).', error: 'Entschuldigung, ich konnte keine Antwort abrufen. Bitte rufen Sie +82-31-366-1984 an 😊', reset: 'Chat zurücksetzen', consultant: 'Telefon', namePh: 'Name', callbackTitle: 'Hinterlassen Sie Ihre Nummer', callbackDesc: 'Unser Team wird Sie kontaktieren', callbackSuccess: 'Ihre Kontaktdaten wurden übermittelt! Unser Team wird sich bald bei Ihnen melden', callbackPhonePh: 'Telefonnummer eingeben', callbackSubmit: 'Rückruf anfordern', callbackPhoneErr: 'Bitte Telefonnummer eingeben' },
    fr: { title: 'Kapu', subtitle: 'Votre guide d\'achat', studio: 'Jouez ici!', placeholder: 'Tapez un message...', send: 'Envoyer', close: 'Fermer', editor: 'Designer dans l\'éditeur', cart: 'Ajouter au panier', upload: 'Joindre image', tooBig: 'Fichier trop volumineux (max 10MB).', error: 'Désolé, je n\'ai pas pu obtenir de réponse. Veuillez appeler le +82-31-366-1984 😊', reset: 'Réinitialiser', consultant: 'Téléphone', namePh: 'Nom', callbackTitle: 'Laissez votre numéro', callbackDesc: 'Notre équipe vous contactera après vérification', callbackSuccess: 'Vos coordonnées ont été envoyées ! Notre équipe vous contactera bientôt', callbackPhonePh: 'Entrez votre téléphone', callbackSubmit: 'Demander un rappel', callbackPhoneErr: 'Entrez votre téléphone' },
    ar: { title: 'كابو', subtitle: 'دليل التسوق', studio: '!العب هنا', placeholder: '...اكتب رسالة', send: 'إرسال', close: 'إغلاق', editor: 'التصميم في المحرر', cart: 'أضف للسلة', upload: 'إرفاق صورة', tooBig: 'الملف كبير جداً (الحد 10MB).', error: 'عذراً، لم أتمكن من الحصول على رد. يرجى الاتصال بنا على +82-31-366-1984 😊', reset: 'إعادة تعيين', consultant: 'الهاتف', namePh: 'الاسم', callbackTitle: 'اترك رقمك', callbackDesc: 'سيتواصل فريقنا معك بعد المراجعة', callbackSuccess: 'تم إرسال معلومات الاتصال! سيتواصل فريقنا معك قريباً', callbackPhonePh: 'أدخل رقم الهاتف', callbackSubmit: 'طلب معاودة الاتصال', callbackPhoneErr: 'أدخل رقم هاتفك' },
};
...
window._quoteToCart = async function(quoteId) {
    ...
    try {
        const { addProductToCartDirectly } = await import('./order.js?v=733');
...
function _attachTooltip(el, type) {
    ...
    let content = '';
    if (type === 'phone') {
        if (lang === 'kr') content = '<div style="font-weight:800;margin-bottom:6px;">📞 전화 문의</div><div>🏭 본사: 031-366-1984</div><div>👤 지숙: 010-3455-1946</div><div>👤 은미: 010-7793-5393</div><div>👤 성희: 010-4994-5950</div><div>👤 연두: 010-2525-9943</div><div style="margin-top:4px;font-size:11px;color:#94a3b8;">⏰ 평일 09:00~18:00</div>';
...
async function sendMessage(text, imageData) {
    ...
    // ★ 사용자가 연락처/이메일/계좌 키워드를 직접 입력하면 AI 호출 없이 바로 안내 카드 표시
    if (text && !imageData) {
        ...
        const _emailKeys = ['이메일','이메 일','이멜','메일주소','메일 주소','이메일주소','이메일 주소','메일로',
            ...
            'e-mail-adresse','mail-adresse',
            'adresse e-mail','courriel',
            'بريد إلكتروني','إيميل'];
        if (_emailKeys.some(k => _userLower.includes(k))) {
            addBubble(text, 'user');
            showEmailCard();
            return;
        }
        ...
        // 2) 계좌/무통장입금 요청
        const _bankKeys = ['계좌','계좌번호','무통장','무통장입금','입금계좌','은행계좌','송금','이체','계좌이체','입금하려','입금하고',
            '口座','銀行口座','振込','入金口座','銀行振込',
            'bank account','wire transfer','wire-transfer','account number','bank info','banking info',
            '账户','银行账户','银行账号','转账','汇款',
            'cuenta bancaria','número de cuenta','transferencia bancaria',
            'bankkonto','kontonummer','überweisung','bankverbindung',
            'compte bancaire','numéro de compte','virement bancaire',
            'حساب مصرفي','رقم الحساب','تحويل مصرفي'];
        if (_bankKeys.some(k => _userLower.includes(k))) {
            addBubble(text, 'user');
            showBankCard();
            return;
        }

        // 3) 전화/매니저/상담사 요청 → 전화번호 카드 (기존 콜백 폼 대체)
        const _phoneKeys = ['전화번호','전화 번호','연락처','전화','휴대폰','핸드폰','번호 알려','번호알려','콜','call',
            '매니저 연결','매니저연결','매니저 전화','매니저전화','매니저 번호','매니저번호','매니저 연락','매니저연락','매니저들',
            '상담사 연결','상담사연결','상담사 요청','상담사요청','상담사','상담원','상담원 연결','상담원연결',
            '인간 상담','인간상담','사람 연결','사람연결','직접 통화','통화하고','통화 하고','통화하기',
            '본사 전화','본사전화','본사 번호','본사번호','본사 연락','본사연락','안내전화','안내 전화','안내번호','안내 번호',
            '電話','電話番号','連絡先','担当者','担当者接続','マネージャー','コールバック',
            'phone','phone number','contact number','call us','contact us','consultant','connect agent','human agent','talk to human','real person','manager','callback',
            '电话','电话号码','联系电话','经理','客服',
            'teléfono','número de teléfono','contacto telefónico','llamar',
            'telefon','telefonnummer','rückruf',
            'téléphone','numéro de téléphone','rappel',
            'هاتف','رقم الهاتف','اتصل بنا'];
        if (_phoneKeys.some(k => _userLower.includes(k))) {
            addBubble(text, 'user');
            showPhoneCard();
            return;
        }
...
- 결제 수단 / 카드 / 무통장 → 짧게 안내 (계좌번호는 고객이 명시적으로 물어볼 때만)
- 사업자등록 / 세금계산서 → 짧게 안내
- 환불 / 교환 / A/S → 정책 짧게 안내
- 단순 인사 / 잡담 → 짧게 인사만 ("안녕하세요! 무엇을 도와드릴까요?")

[★★★ 연락처/주소 안내 — 절대 규칙 ★★★]
콜백/연락처 남기기 폼은 더 이상 사용하지 않는다. 절대로 "연락처를 남겨주세요", "담당자가 연락드리겠습니다", "콜백 신청", "연락처 남기기 버튼" 같은 말을 하지 마라. 대신 아래 정보를 직접 안내한다:

▶ 회사 정보 (정확한 사실 — 절대 다른 주소를 만들어내지 마라):
   회사명: (주)카멜레온프린팅
   대표자: 조재호
   사업자등록번호: 470-81-02808
   본사 주소: **경기도 화성시 우정읍 한말길 72-2**
   업태/종목: 제조업 / 서비스업
   ※ 절대 "성남시 분당구", "서울", "용인" 등 다른 주소를 말하지 마라. 모르면 차라리 "본사 031-366-1984로 연락 주세요"라고 말해라.

▶ 고객이 본사 주소/회사 위치/오시는 길/공장 주소를 요청하면:
   시스템이 자동으로 주소 카드를 띄워준다. 너는 짧게 "본사 주소 안내드릴게요" 정도만 말하면 된다.

▶ 고객이 전화/연락처/매니저 연락처/상담사 연결을 요청하면:
   본사: 031-366-1984 (평일 09:00~18:00)
   ※ 시스템이 자동으로 매니저 전화번호 카드를 띄워주므로 너는 짧게 "전화번호 안내드릴게요" 정도만 말하면 된다.

▶ 고객이 이메일을 명시적으로 물으면 (예: "이메일 알려줘", "메일 주소"):
   design@chameleon.design
   ※ 고객이 이메일을 묻지 않았다면 절대 먼저 알려주지 마라.

▶ 고객이 무통장입금 계좌/계좌번호를 명시적으로 물으면:
   국민은행 647701-04-277763 (예금주: 카멜레온프린팅)
   ※ 고객이 계좌를 묻지 않았다면 절대 먼저 알려주지 마라.

▶ 고객이 단순히 "전화/연락처/매니저/주소"를 물었는데 이메일이나 계좌번호까지 같이 안내하지 마라. 묻는 것만 답한다.

▶ 대답하기 곤란한 복잡한 견적·특수 프로젝트·대규모 전시 문의 → "전문 상담이 필요한 건이라 매니저에게 직접 전화 주시는 게 빠릅니다. 본사 031-366-1984로 연락 주세요." 라고 안내한다.
...
[셀프디자인 요청] 고객이 "직접 디자인", "에디터 열어줘", "셀프로 만들고 싶다" 등 말하면 한 문장만: "✏️ 직접 디자인하시려면 '셀프디자인'이라고 입력해주세요. 사이즈 입력 후 에디터가 바로 열립니다!"`
        ...
        // [DEPRECATED] 콜백 폼 안내 자동 트리거 제거됨.
        // 매니저/연락처 관련 키워드는 sendMessage 진입부에서 showPhoneCard()로 처리됨.
        // 본사가 콜백 요청을 더 이상 확인하지 않으므로 콜백 폼은 띄우지 않는다.
...
// ═══════════════════════════════════════
// 📞 연락처 안내 카드 (전화 / 이메일 / 계좌)
// — 콜백 요청 폼 대신 단순히 정보를 표시
// ═══════════════════════════════════════

// 전화 안내 카드 — chatbot_knowledge에서 활성 매니저만 가져옴
async function showPhoneCard() {
    if (!chatArea) return;
    const lang = getLang();
    const labels = {
        kr: { title:'📞 전화 문의', hq:'본사', mgr:'담당 매니저', vac:'(휴가중)', hours:'⏰ 평일 09:00~18:00', tip:'언제든 편하게 전화 주세요!' },
        ja: { title:'📞 お電話', hq:'本社', mgr:'担当マネージャー', vac:'(休暇中)', hours:'⏰ 平日 09:00〜18:00', tip:'お気軽にお電話ください！' },
        en: { title:'📞 Phone Contact', hq:'HQ', mgr:'Manager', vac:'(On leave)', hours:'⏰ Mon-Fri 09:00-18:00 KST', tip:'Feel free to call us anytime!' },
        zh: { title:'📞 电话咨询', hq:'总部', mgr:'负责经理', vac:'(休假中)', hours:'⏰ 周一至周五 09:00-18:00', tip:'欢迎随时来电！' },
        es: { title:'📞 Contacto', hq:'Sede', mgr:'Asesor', vac:'(De vacaciones)', hours:'⏰ Lun-Vie 09:00-18:00', tip:'¡Llámanos cuando quieras!' },
        de: { title:'📞 Telefon', hq:'Zentrale', mgr:'Betreuer', vac:'(Im Urlaub)', hours:'⏰ Mo-Fr 09:00-18:00', tip:'Rufen Sie uns gerne jederzeit an!' },
        fr: { title:'📞 Téléphone', hq:'Siège', mgr:'Responsable', vac:'(En congé)', hours:'⏰ Lun-Ven 09:00-18:00', tip:'N\'hésitez pas à nous appeler !' },
        ar: { title:'📞 الاتصال', hq:'المقر', mgr:'المدير', vac:'(في إجازة)', hours:'⏰ الإثنين-الجمعة 09:00-18:00', tip:'اتصل بنا في أي وقت!' }
    };
    const L = labels[lang] || labels.en;

    // KR/JP은 본사 전화번호 다름. 다른 언어는 한국 본사로 안내
    const hqPhone = (lang === 'ja') ? '047-712-1148' : '031-366-1984';

    // 매니저 목록 (KR 만 — 한국 매니저는 한국어로만 노출)
    let mgrItems = '';
    if (lang === 'kr') {
        try {
            const sb = getSb();
            if (sb) {
                ...
                rows.forEach(r => {
                    ...
                    const isOff = r.is_active === false;
                    if (isOff) {
                        mgrItems += `<div style="display:flex;align-items:center;gap:8px;padding:10px 12px;background:#f1f5f9;border-radius:10px;color:#94a3b8;text-decoration:line-through;opacity:0.6;cursor:not-allowed;font-size:13px;">
                            <span style="width:18px;text-align:center;">🌴</span>
                            <span style="flex:1;">${r.question} ${L.mgr}</span>
                            <span style="font-size:11px;">${L.vac}</span>
                        </div>`;
                    } else {
                        mgrItems += `<a href="tel:${phone}" style="display:flex;align-items:center;gap:8px;padding:10px 12px;background:#fff;border:1px solid #e2e8f0;border-radius:10px;text-decoration:none;color:#1e293b;font-size:14px;font-weight:600;transition:all 0.15s;" onmouseover="this.style.background='#fef3c7';this.style.borderColor='#f59e0b'" onmouseout="this.style.background='#fff';this.style.borderColor='#e2e8f0'">
                            <span style="width:18px;text-align:center;color:#f59e0b;">👩</span>
                            <span style="flex:1;">${r.question} ${L.mgr}</span>
                            <span style="color:#7c3aed;font-weight:700;">${phoneFmt}</span>
                        </a>`;
                    }
                });
            }
        } catch(e) { console.warn('[showPhoneCard] manager fetch failed', e); }
    }
    ...
    row.innerHTML = `
        ...
        <div style="background:#fff;border:1px solid #e0e7ff;border-radius:16px;padding:14px 16px;max-width:90%;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            <div style="font-size:14px;font-weight:800;color:#1e293b;margin-bottom:10px;">${L.title}</div>
            <a href="tel:${hqPhone}" style="display:flex;align-items:center;gap:8px;padding:12px 14px;background:#ecfdf5;border:1.5px solid #10b981;border-radius:10px;text-decoration:none;color:#065f46;font-size:15px;font-weight:800;margin-bottom:${mgrItems?'10px':'8px'};transition:all 0.15s;" onmouseover="this.style.background='#d1fae5'" onmouseout="this.style.background='#ecfdf5'">
                <span style="font-size:16px;">🏭</span>
                <span style="flex:1;">${L.hq}</span>
                <span>${hqPhone}</span>
            </a>
            ${mgrItems ? `<div style="display:flex;flex-direction:column;gap:6px;margin-bottom:10px;">${mgrItems}</div>` : ''}
            <div style="font-size:11px;color:#94a3b8;text-align:center;">${L.hours}</div>
        </div>
    `;
...
function showEmailCard() {
    ...
    const lang = getLang();
    const titles = {
        kr:'✉️ 이메일 문의', ja:'✉️ メールお問い合わせ', en:'✉️ Email Contact',
        zh:'✉️ 电子邮件', es:'✉️ Correo electrónico', de:'✉️ E-Mail-Kontakt',
        fr:'✉️ Contact par e-mail', ar:'✉️ البريد الإلكتروني'
    };
    const tips = {
        kr:'24시간 접수 가능합니다. 평일 영업시간에 답변드려요!',
        ja:'24時間受付。平日の営業時間内にお返事いたします！',
        en:'Available 24/7. We respond during weekday business hours.',
        zh:'24小时受理，工作日营业时间内回复。',
        es:'Disponible 24/7. Responderemos en horario laboral.',
        de:'24/7 erreichbar. Antwort während der Geschäftszeiten.',
        fr:'Disponible 24/7. Réponse pendant les heures ouvrables.',
        ar:'متاح 24/7. نرد خلال ساعات العمل في أيام الأسبوع.'
    };
    const row = document.createElement('div');
    row.className = 'adv-row adv-row-ai';
    row.innerHTML = `
        <div class="adv-avatar"><i class="fa-solid fa-envelope"></i></div>
        <div style="background:#fff;border:1px solid #e0e7ff;border-radius:16px;padding:14px 16px;max-width:90%;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            <div style="font-size:14px;font-weight:800;color:#1e293b;margin-bottom:10px;">${titles[lang]||titles.en}</div>
            <a href="mailto:design@chameleon.design" style="display:flex;align-items:center;gap:8px;padding:12px 14px;background:#eff6ff;border:1.5px solid #3b82f6;border-radius:10px;text-decoration:none;color:#1e40af;font-size:15px;font-weight:800;transition:all 0.15s;" onmouseover="this.style.background='#dbeafe'" onmouseout="this.style.background='#eff6ff'">
                <span style="font-size:16px;">✉️</span>
                <span style="flex:1;">design@chameleon.design</span>
            </a>
            <div style="font-size:11px;color:#94a3b8;text-align:center;margin-top:8px;">${tips[lang]||tips.en}</div>
        </div>
    `;
    chatArea.appendChild(row);
    scrollChat();
...
function showAddressCard() {
    ...
    const lang = getLang();
    const titles = {
        kr:'📍 본사 주소', ja:'📍 本社住所', en:'📍 HQ Address',
        zh:'📍 总部地址', es:'📍 Dirección', de:'📍 Adresse',
        fr:'📍 Adresse', ar:'📍 العنوان'
    };
    const tips = {
        kr:'평일 09:00~18:00 방문 가능. 방문 전 본사 031-366-1984로 미리 연락 주세요!',
        ja:'平日 09:00〜18:00 訪問可能。事前に 031-366-1984 までご連絡ください。',
        en:'Visits welcome on weekdays 09:00-18:00. Please call HQ +82-31-366-1984 in advance.',
        zh:'工作日 09:00~18:00 欢迎访问。请提前致电总部 +82-31-366-1984。',
        es:'Visitas bienvenidas L-V 09:00-18:00. Llame a +82-31-366-1984 antes.',
        de:'Besuche werktags 09:00-18:00. Bitte zuvor +82-31-366-1984 anrufen.',
        fr:'Visites en semaine 09:00-18:00. Veuillez appeler le +82-31-366-1984 à l\'avance.',
        ar:'الزيارات مرحب بها أيام الأسبوع 09:00-18:00. يرجى الاتصال أولاً.'
    };
    const mapBtnLabels = {
        kr:'🗺️ 네이버 지도에서 보기', ja:'🗺️ 地図で見る', en:'🗺️ View on Map',
        zh:'🗺️ 在地图查看', es:'🗺️ Ver en mapa', de:'🗺️ Auf Karte ansehen',
        fr:'🗺️ Voir sur la carte', ar:'🗺️ عرض على الخريطة'
    };
    const addrKR = '경기도 화성시 우정읍 한말길 72-2';
    const addrLabels = {
        ja: 'Gyeonggi-do, Hwaseong-si, Ujeong-eup, Hanmal-gil 72-2 (韓国)',
        en: '72-2 Hanmal-gil, Ujeong-eup, Hwaseong-si, Gyeonggi-do, South Korea',
        zh: '韩国京畿道华城市友井邑 한말길 72-2',
        es: '72-2 Hanmal-gil, Ujeong-eup, Hwaseong-si, Gyeonggi-do, Corea del Sur',
        de: '72-2 Hanmal-gil, Ujeong-eup, Hwaseong-si, Gyeonggi-do, Südkorea',
        fr: '72-2 Hanmal-gil, Ujeong-eup, Hwaseong-si, Gyeonggi-do, Corée du Sud',
        ar: '72-2 Hanmal-gil, Ujeong-eup, Hwaseong-si, Gyeonggi-do, كوريا الجنوبية'
    };
    const addrDisplay = (lang === 'kr') ? addrKR : (addrLabels[lang] || addrLabels.en);
    const naverMapUrl = 'https://map.naver.com/p/search/' + encodeURIComponent(addrKR);
    const googleMapUrl = 'https://www.google.com/maps/search/?api=1&query=' + encodeURIComponent(addrKR);
    const mapUrl = (lang === 'kr') ? naverMapUrl : googleMapUrl;

    const row = document.createElement('div');
    row.className = 'adv-row adv-row-ai';
    row.innerHTML = `
        <div class="adv-avatar"><i class="fa-solid fa-location-dot"></i></div>
        <div style="background:#fff;border:1px solid #e0e7ff;border-radius:16px;padding:14px 16px;max-width:90%;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            <div style="font-size:14px;font-weight:800;color:#1e293b;margin-bottom:10px;">${titles[lang]||titles.en}</div>
            <div style="padding:12px 14px;background:#fef3c7;border:1.5px solid #f59e0b;border-radius:10px;color:#78350f;margin-bottom:10px;">
                <div style="font-size:12px;font-weight:700;margin-bottom:4px;">(주)카멜레온프린팅</div>
                <div style="font-size:14px;font-weight:800;line-height:1.5;">${addrDisplay}</div>
            </div>
            <a href="${mapUrl}" target="_blank" style="display:flex;align-items:center;justify-content:center;gap:6px;padding:10px;background:#10b981;color:#fff;border-radius:10px;text-decoration:none;font-size:13px;font-weight:700;transition:all 0.15s;" onmouseover="this.style.background='#059669'" onmouseout="this.style.background='#10b981'">
                ${mapBtnLabels[lang]||mapBtnLabels.en}
            </a>
            <div style="font-size:11px;color:#94a3b8;text-align:center;margin-top:8px;">${tips[lang]||tips.en}</div>
        </div>
    `;
...
function showBankCard() {
    ...
    const lang = getLang();
    const titles = {
        kr:'🏦 무통장입금 계좌', ja:'🏦 銀行振込口座', en:'🏦 Bank Account',
        zh:'🏦 银行账户', es:'🏦 Cuenta Bancaria', de:'🏦 Bankkonto',
        fr:'🏦 Compte Bancaire', ar:'🏦 الحساب المصرفي'
    };
    const tips = {
        kr:'예금주: 카멜레온프린팅 / 결제 후 자동 확인됩니다',
        ja:'名義: カメレオンプリンティング / お振込後、自動で確認されます',
        en:'Account holder: Chameleon Printing / Auto-confirmed after payment',
        zh:'户名: 카멜레온프린팅 / 付款后自动确认',
        es:'Titular: Chameleon Printing / Confirmación automática',
        de:'Kontoinhaber: Chameleon Printing / Automatische Bestätigung',
        fr:'Titulaire: Chameleon Printing / Confirmation automatique',
        ar:'صاحب الحساب: Chameleon Printing / تأكيد تلقائي'
    };
    const isJP = lang === 'ja';
    const bankName = isJP ? '楽天銀行' : '국민은행';
    const acctNum = isJP ? '8487335989' : '647701-04-277763';
    const row = document.createElement('div');
    row.className = 'adv-row adv-row-ai';
    row.innerHTML = `
        <div class="adv-avatar"><i class="fa-solid fa-building-columns"></i></div>
        <div style="background:#fff;border:1px solid #e0e7ff;border-radius:16px;padding:14px 16px;max-width:90%;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            <div style="font-size:14px;font-weight:800;color:#1e293b;margin-bottom:10px;">${titles[lang]||titles.en}</div>
            <div style="padding:12px 14px;background:#f0fdf4;border:1.5px solid #16a34a;border-radius:10px;color:#15803d;">
                <div style="font-size:12px;font-weight:700;margin-bottom:4px;">${bankName}</div>
                <div style="font-size:18px;font-weight:900;letter-spacing:1px;font-family:monospace;">${acctNum}</div>
            </div>
            <div style="font-size:11px;color:#94a3b8;text-align:center;margin-top:8px;">${tips[lang]||tips.en}</div>
        </div>
    `;
...
// ═══════════════════════════════════════
// 연락처 남기기 (콜백 요청) 기능 — DEPRECATED, kept for backward compat only
// ═══════════════════════════════════════
