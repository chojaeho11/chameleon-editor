...
// ── 통화 ──
const _cur = (_cc==='JP'||_cc==='JA') ? {r:0.2,s:'¥',pre:true} : (_cc==='US'||_cc==='EN') ? {r:0.002,s:'$',pre:true} : (_cc==='CN'||_cc==='ZH') ? {r:0.05,s:'¥',pre:true} : (_cc==='ES'||_cc==='DE'||_cc==='FR') ? {r:0.002,s:'€',pre:true} : (_cc==='AR') ? {r:0.001,s:'$',pre:true} : (_cc==='KR'||_cc==='KO') ? {r:1,s:'원',pre:false} : {r:0.002,s:'$',pre:true};
