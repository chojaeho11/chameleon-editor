...
import { ADDON_DB, currentUser, sb } from "./config.js?v=185";
import { pageDataList, currentPageIndex } from "./canvas-pages.js?v=185"; // 페이지 인덱스 가져오기
import { FONT_URLS, FONT_ALIASES } from "./fonts.js?v=185";
