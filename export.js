...
import { ADDON_DB, currentUser, sb } from "./config.js?v=147";
import { pageDataList, currentPageIndex } from "./canvas-pages.js?v=147"; // 페이지 인덱스 가져오기
import { FONT_URLS, FONT_ALIASES } from "./fonts.js?v=147";
