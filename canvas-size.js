...
import { canvas, setBaseSize, setGlobalMode, setGlobalSizeName, setGuideOn, maxLimitMM, currentMode } from "./canvas-core.js?v=290";
import { drawGuides } from "./canvas-guides.js?v=290";
import { openProductDetail } from "./order.js?v=290";
