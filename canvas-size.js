...
import { canvas, setBaseSize, setGlobalMode, setGlobalSizeName, setGuideOn, maxLimitMM, currentMode } from "./canvas-core.js?v=140";
import { drawGuides } from "./canvas-guides.js?v=140";
import { openProductDetail } from "./order.js?v=140";
