...
import { canvas, setBaseSize, setGlobalMode, setGlobalSizeName, setGuideOn, maxLimitMM, currentMode } from "./canvas-core.js?v=294";
import { drawGuides } from "./canvas-guides.js?v=294";
import { openProductDetail } from "./order.js?v=454";
...
export function resizeCanvasToFit() {
    ...
    // padding 작게 → 보드가 화면 폭을 거의 가득 채움
    const padding = _isMobile ? 24 : 160;
