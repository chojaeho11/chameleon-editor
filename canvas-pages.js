...
import { applySize, resizeCanvasToFit } from "./canvas-size.js?v=279";
import { calculateBoxPrice } from "./box-nesting.js?v=279";
...
window.downloadBoxLayoutPDF = async function() {
    ...
    try {
        const { generateBoxLayoutPDF } = await import('./export.js?v=279');
